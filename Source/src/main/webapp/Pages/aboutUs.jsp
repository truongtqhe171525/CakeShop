...
<body>
    <header class="header">
        ...
        <nav class="header-navbar">
            <ul>
                <li ><a href="/"> Home </a></li>
                <li class="header-target"><a href="/aboutUs"> About Us </a></li>
    ...
    <main>
        <div class="slice-top">
            <img src="//bakecy-store-demo.myshopify.com/cdn/shop/files/slideshowV2-bg1.jpg?v=1677576599" alt=""/>
            <div class="slice-top-content">
                <h1> Sweet Cake <br> Delicacy Collection </h1>
                <button><a href="/shop"> Shop now </a></button>
            </div>
        </div>
        
        <div class="about-introduce-container">
            <div class="about-introduce">
                <div class="introduce-content">
                    <h1>Our Story</h1>
                    <h4>THE HIGH STRESS FAVOUTIRE</h4>
                ...
                <div class="introduce-image">
                    <img loading="lazy" width="" height="" class="w-100" src=" //bakecy-store-demo.myshopify.com/cdn/shop/files/about1.1.jpg?v=1677622665 ">
                </div>
            </div>
            ...
            <div class="about-introduce">
                <div class="introduce-image">
                    <img loading="lazy" width="" height="" class="w-100" src=" //bakecy-store-demo.myshopify.com/cdn/shop/files/about1.2.jpg?v=1677622665 ">
                </div>
                <div class="introduce-content">
                    <h1>Who We Are ?</h1>
                    <h4>THE HIGH STRESS FAVOUTIRE</h4>
    ...
    <div class="our-chef">
        <h3 class="chef-title"> Our Chef </h3>
        <div class="list-chef">
            <div class="chef-card">
                <div class="chef-image">
                    <img decoding="async" src="https://warethemes.com/wordpress/bready/wp-content/uploads/2018/09/1.png" alt="Juan Olson">
                </div>
            ...
            <div class="chef-card">
                <div class="chef-image">
                    <img decoding="async" src="https://warethemes.com/wordpress/bready/wp-content/uploads/2018/09/2.png" alt="Harold Santos">
                </div>
            ...
            <div class="chef-card">
                <div class="chef-image">
                <img decoding="async" src="https://warethemes.com/wordpress/bready/wp-content/uploads/2018/09/3.png" alt="Joel Harmon">
                </div>
            ...
            <div class="chef-card">
                <div class="chef-image">
                    <img decoding="async" src="https://warethemes.com/wordpress/bready/wp-content/uploads/2018/09/4.png" alt="Ricardo Manning">
                </div>
