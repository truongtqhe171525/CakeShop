    ...
    <header class="header">
        ...
        <nav class="header-navbar">
            <ul>
                ...
                <li class="header-target"><a href="/contact"> Contact </a></li>
            </ul>
        </nav>
    ...
    <main>
        ...
        <div class="contact-container">
            <div class="contact-form">
                ...
                <div class="form-group">
                    <label>YOUR MESSAGER <sup>*</sup></label>
                    <textarea class="form-control" rows="7" name="content"></textarea>
                </div>
                <div class="form-group submit">
                    <button class="ps-btn ps-btn--yellow">Send your message</button>
                </div>
            </div>
            <div class="block-contact">
                <div>
                    ...
                    <p><i class="fa fa-envelope-o"></i>hello@example.com</p>
                    <p><i class="fa fa-phone"></i> +1 650-253-0000</p>
                </div>
                <div>
                    <h3>Office at Vietnam</h3>
                    <h4>189/32, ABC, VIET NAM</h4>
                    <p><i class="fa fa-envelope-o"></i>hello@basis.com</p>
                    <p><i class="fa fa-phone"></i> +1 650-253-0000</p>
                </div>
                <div>
                    <h3>Office at Paris</h3>
                    <h4>189/32 PARIS, FRANCE</h4>
                    <p><i class="fa fa-envelope-o"></i>hello@basis.com</p>
                    <p><i class="fa fa-phone"></i> +1 650-253-0000</p>
                </div>
                <div>
